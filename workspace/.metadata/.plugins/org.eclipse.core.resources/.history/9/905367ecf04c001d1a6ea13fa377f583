...
public class RegEx {
    ...
    public static void main(String arg[]) {
        ...
        if (regEx.length()<1) {
            ...
            System.out.println(ndfAutomaton.toString());
            DFAutomaton dfAutomaton = DFAutomaton.regExTree2NFA(ndfAutomaton);
            System.out.println(dfAutomaton.toString());
            dfAutomaton.lireTexte(fileName);
        }
